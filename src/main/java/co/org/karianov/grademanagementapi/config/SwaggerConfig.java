package co.org.karianov.grademanagementapi.config;
...
public class SwaggerConfig {
	...
	private ApiInfo buildApiInfo() {
		// @formatter:off
		return new ApiInfoBuilder().title("App for grade management")
	...
	public Docket buildSwaggerDocumentation() {
		...
		return new Docket(DocumentationType.SWAGGER_2)
				.select()
				.apis(RequestHandlerSelectors.basePackage("co.org.karianov.grademanagementapi.controller"))
